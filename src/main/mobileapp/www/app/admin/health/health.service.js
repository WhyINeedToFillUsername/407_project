(function() {
    ...
    JhiHealthService.$inject = ['$rootScope', '$http', 'SERVER_URL'];

    function JhiHealthService ($rootScope, $http, SERVER_URL) {
        var separator = '.';
        var service = {
        ...
        function checkHealth () {
            return $http.get(SERVER_URL + 'management/health').then(function (response) {
